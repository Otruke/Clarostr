            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="pay-now-box p-lg-5 p-sm-5 p-sm-3">
                        ...
                        <form method="POST" action="{{ route('pay') }}" id="subPayment">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="">
                                        ...
                                        <i class="fas fa-money-check"></i>
                                            ...
                                            <p class="dashboard-note">Kindly click on the button below for the payment of ₦10,000 to complete your monthly subscription.</p>
                                        ...
                                        <input name="amount" type="hidden" value=10,000 />
                                        <input type="hidden" name="payment_method" value="card" />
                                        <input type="hidden" name="description" value="mSub"  />
