...
<head>
    <meta charset="utf-8" />
    <title>Clarostream Network | Generation Tree</title>
...
<body>
    ...
    <!-- Main section Start -->
    <div class="l-main" style="position: fixed; vh: 100%;">

            <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12 col-12">
                    <div class="sv_heading_wraper">

                        <h3 class="dashboard-title">MY GENEAOLOGY</h3>
                    </div>
                </div>


                <h5> Generation Tree for {{ $user->first_name }}</h5>
                ...
                <div style="width: 100%; text-align: center;">
                    ...
                    <!-- Display the descendants -->
                        ...
                        @if(!$descendants->count())
                            <div style = "height: 250px; width: 100%; text-align: center;">No descendants yet.</div>
                        @else
                            <div class="generation-tree">
                                @foreach ($user->directReferrals as $directReferral)
                                    <div class="generation-node">
                                        <p>{{ $directReferral->username }}</p>
                                        @include('referrals.partials.descendants', ['descendant' => $directReferral, 'level' => 1])
                                    </div>
                                @endforeach
                            </div>
    ...
    <!--  transactions wrapper end --> 
     ...
     <!--  footer  wrapper start -->
        <div class="copy_footer_wrapper" style="position: fixed; bottom: 0; width: 100%;">
            <div class="container-fluid">
                <div class="row">
