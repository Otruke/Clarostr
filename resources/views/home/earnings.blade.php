            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-6 col-lg-6 col-sm-12 col-12">
                    <div class="view_profile_wrapper float_left mb-5">
                        <div class="userdescc">
                            <h4 class="dashboard-note font-700 text-color-orange">Gross Profit</h4>
                        ...
                        <div class="row">
                            <div class="crm_customer_table_main_wrapper float_left">
                                ...
                                <div class="table-responsive gross-earning-table-div">
                                    <table id="" class="table cs-table crm_customer_table_inner_Wrapper mt-5">
                                        <tbody>
                                            <tr class="background_white">
                                                <td>Accumulated Earning Period</td>
                                                <td>{{ Auth::user()->created_at->format('F d, Y') }} - Present</td>
                                            </tr>
                ...
                <div class="col-xl-6 col-md-6 col-lg-6 col-sm-12 col-12">
                    <div class="view_profile_wrapper float_left mb-5">
                        <div class="userdescc">
                            <h4 class="dashboard-note font-700 text-color-orange">Net Profit</h4>
                        ...
                        <div class="row">
                            <div class="crm_customer_table_main_wrapper float_left">
                                ...
                                <div class="table-responsive">
                                    <table id="earning-details-table" class="table cs-table crm_customer_table_inner_Wrapper mt-5">
                                        <tbody>
                                            <tr class="background_white">
                                    ...
                                    <div class="text-center">
                                        <form id="withdraw-form" action="{{ route('transfer') }}" method="POST">
                                            @csrf
                                            @foreach($netEarnings as $category => $net)
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                form.addEventListener('submit', function (event) {
                    const today = new Date().getDay(); // 5 corresponds to Friday
                    if (today !== 5) {
                        event.preventDefault();
                        alert("Withdrawals are only made on Fridays.");
                    }
                });
            });
        </script>
